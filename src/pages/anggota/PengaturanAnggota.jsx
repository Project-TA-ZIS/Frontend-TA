      ...
      <div className="min-h-screen bg-gray-50 p-4 md:p-10 font-['Manrope']">
        ...
        <div className="flex flex-col lg:flex-row gap-5 md:gap-8">
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 text-center flex flex-col items-center">
              <div className="relative mb-4 md:mb-6">
                <div className="w-20 h-20 md:w-32 md:h-32 bg-[#0F766E] rounded-full flex items-center justify-center text-white font-bold text-3xl md:text-4xl shadow-md border-4 border-white">
              ...
              <p className="text-[10px] md:text-sm font-bold text-[#10B981] mt-1 uppercase tracking-wider">
                {formData.role || ""}
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-8">
              {isSuccess && (
                <div className="mb-5 p-3 md:p-4 bg-emerald-50 border border-emerald-200 rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5 md:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-2.5 pt-2">
                  <button
                    ...
                    className="px-5 py-2.5 md:py-3 rounded-xl text-sm font-bold text-white bg-amber-500 hover:bg-amber-600 transition-colors w-full sm:w-auto"
                  >
                    Ganti Password
                  </button>
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2.5 md:py-3 rounded-xl text-sm font-bold text-white bg-[#10B981] hover:bg-[#059669] shadow-sm transition-colors w-full sm:w-auto"
                  >
                    Simpan Perubahan
                  </button>
                </div>
