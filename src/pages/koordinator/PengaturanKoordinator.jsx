...
export default function PengaturanKoordinator() {
  ...
  const validateForm = () => {
    ...
    if (formData.passwordBaru) {
      ...
      if (!formData.passwordLama)
        newErrors.passwordLama = "Masukkan kata sandi lama!";
    }
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      console.log("Data Koordinator disimpan:", formData);
      setIsSuccess(true);
      setFormData((prev) => ({
        ...prev,
        passwordLama: "",
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full pl-11 pr-4 py-3 bg-gray-50 text-sm rounded-xl outline-none font-semibold transition-all border ${errors.passwordLama ? "border-red-500 focus:ring-red-500" : "border-gray-200 focus:ring-[#10B981]"}`}
                        />
                      </div>
                      {errors.passwordLama && (
                        <p className="text-red-500 text-[11px] font-bold mt-1.5 pl-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 bg-gray-50 text-sm rounded-xl outline-none font-semibold transition-all border ${errors.passwordBaru ? "border-red-500 focus:ring-red-500" : "border-gray-200 focus:ring-[#10B981]"}`}
                        />
                        {errors.passwordBaru && (
                          <p className="text-red-500 text-[11px] font-bold mt-1.5 pl-1">
                            {errors.passwordBaru}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 bg-gray-50 text-sm rounded-xl outline-none font-semibold transition-all border ${errors.konfirmasiPassword ? "border-red-500 focus:ring-red-500" : "border-gray-200 focus:ring-[#10B981]"}`}
                        />
