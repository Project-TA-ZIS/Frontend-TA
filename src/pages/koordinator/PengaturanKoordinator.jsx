        ...
        <div className="w-full lg:w-1/3">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center flex flex-col items-center">
            <div className="relative mb-6">
              <div className="w-32 h-32 bg-[#0F766E] rounded-full flex items-center justify-center text-white font-bold text-4xl shadow-md border-4 border-white">SA</div>
              <button className="absolute bottom-0 right-0 bg-[#10B981] hover:bg-[#059669] text-white p-2.5 rounded-full shadow-lg border-2 border-white transition-colors"><Camera size={18} /></button>
            </div>
            <h3 className="text-xl font-extrabold text-gray-900">{formData.nama || "Super Admin"}</h3>
            <p className="text-sm font-bold text-[#10B981] mt-1 uppercase tracking-wider">ADMIN UTAMA</p>
