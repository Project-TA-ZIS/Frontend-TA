          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-gray-900 group-hover:text-[#0F766E] transition-colors">Petugas Amil</p>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">AMIL ZAKAT</p>
              </div>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                <button 
                  onClick={() => { navigate('/amil/pengaturan'); setIsProfileOpen(false); }}
